...
<xsl:variable name="nav_on">#336699;</xsl:variable>
<xsl:variable name="nav_off">#797979;</xsl:variable>
...
<table width="826" cellpadding="1" cellspacing="3" border="0" align="center">
	<tr>
		<td width="826" bgcolor="#A3C2E0">
				<table width="824" cellpadding="3" cellspacing="0" border="0">
				<tr>
					<td width="824" bgcolor="#336699"><font face="arial, helvetica, sans serif" size="2" color="#ffffff">
		...
		<td valign="top" bgcolor="#7da6d4">
			...
			<tr>
				<td align="left" valign="top" height="64">
					...
					<table cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td bgcolor="#ffffff" align="left" height="64" width="202">
							<a href="http://www.expedia.com/default.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif;  font-size: 12px; color: #336699;"><img src="http://media.expedia.com/media/content/expus/graphics/mail/email_elite_logo.jpg" alt="Expedia.com Elite Plus" width="202" height="64" border="0" /></a>
							</td><td><xsl:attribute name="bgcolor">#ffffff</xsl:attribute><xsl:attribute name="width">549</xsl:attribute><xsl:attribute name="height">64</xsl:attribute><xsl:attribute name="background">http://media.expedia.com/media/content/expus/graphics/mail/email_elite_header.jpg</xsl:attribute><table cellpadding="0" cellspacing="2" border="0">
								<tr>
									<td width="549" align="right" valign="middle" style="font-family: arial, helvetica, sans serif; font-size: 12px; color: #000000;">
									<xsl:if test="Template/eyebrowOffer[@state='yes']">
									<xsl:for-each select="Template/eyebrowOffer"><b><xsl:value-of select="@eyebrowText" /></b>&#160;<a><xsl:attribute name="href"><xsl:value-of select="@link" />%%=OmnitureParams('')=%%</xsl:attribute><xsl:attribute name="style">font-family: arial, helvetica, sans serif; font-size: 12px; color:#000000;</xsl:attribute><xsl:value-of select="@eyebrowBlurb"  disable-output-escaping="yes" /></a></xsl:for-each></xsl:if></td>
								</tr>	
								<tr>
									<td width="549" align="right" valign="middle">
										<table cellpadding="0" cellspacing="4" border="0">
										<tr><td><a href="http://www.expedia.com/pub/agent.dll?qscr=info&amp;%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 11px; color: #336699;">My Account</a></td><td style="font-family: arial, helvetica, sans serif; font-size: 11px; color: #336699;">|</td><td valign="bottom"><a href="http://www.expedia.com/daily/service/default.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 11px; color: #336699;">Customer Support</a></td></tr></table></td>
								</tr></table>
							</td><td width="73" height="64" bgcolor="#ffffff" background="http://media.expedia.com/media/content/expus/graphics/mail/email_elite_header.jpg"></td>
					</tr>
					</table>
					</xsl:if>
					...
					<tr>
						<td bgcolor="#ffffff" align="left" height="64" width="202">
							<a href="http://www.expedia.com/default.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif;  font-size: 12px; color: #336699;"><img src="http://media.expedia.com/media/content/expus/graphics/mail/email_elite_logo.jpg" alt="Expedia.com Elite Plus" width="202" height="64" border="0" /></a>
							</td><td><xsl:attribute name="bgcolor">#ffffff</xsl:attribute><xsl:attribute name="width">345</xsl:attribute><xsl:attribute name="height">64</xsl:attribute><xsl:attribute name="background">http://media.expedia.com/media/content/expus/graphics/mail/email_elite_header.jpg</xsl:attribute><table cellpadding="0" cellspacing="2" border="0">
								<tr>
									<td width="345" align="right" valign="middle" style="font-family: arial, helvetica, sans serif; font-size: 12px; color: #000000;">
									<xsl:if test="Template/eyebrowOffer[@state='yes']">
									<xsl:for-each select="Template/eyebrowOffer"><b><xsl:value-of select="@eyebrowText" /></b>&#160;<a><xsl:attribute name="href"><xsl:value-of select="@link" />%%=OmnitureParams('')=%%</xsl:attribute><xsl:attribute name="style">font-family: arial, helvetica, sans serif; font-size: 12px; color:#000000;</xsl:attribute><xsl:value-of select="@eyebrowBlurb"  disable-output-escaping="yes" /></a></xsl:for-each></xsl:if></td>
								</tr>	
								<tr>
									<td width="345" align="right" valign="middle">
										<table cellpadding="0" cellspacing="4" border="0">
										<tr><td><a href="http://www.expedia.com/pub/agent.dll?qscr=info&amp;%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 11px; color: #336699;">My Account</a></td><td style="font-family: arial, helvetica, sans serif; font-size: 11px; color: #336699;">|</td><td valign="bottom"><a href="http://www.expedia.com/daily/service/default.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 11px; color: #336699;">Customer Support</a></td></tr></table></td>
								</tr></table>
							</td>
...
<td style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979;">|</td><td valign="bottom"><a><xsl:attribute name="href">http://www.expedia.com/daily/business/default.asp?%%=OmnitureParams('')=%%</xsl:attribute><xsl:attribute name="style">font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: <xsl:choose><xsl:when test="navigation[@state='biz']"><xsl:value-of select="$nav_on"/></xsl:when><xsl:otherwise><xsl:value-of select="$nav_off"/></xsl:otherwise></xsl:choose> text-decoration: none;</xsl:attribute><nobr>Business Travel</nobr></a></td><td style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979;">|</td><td valign="bottom"><a href="http://www.expedia.com/daily/highlights/rewards/Thank-You-Network.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979; text-decoration: none;"><nobr>ThankYou <xsl:text disable-output-escaping="yes">&amp;#174;</xsl:text></nobr></a></td>
			...
			<tr>
				...
				<td bgcolor="#ffffff">
					...
					<tr>
						<td width="814" bgcolor="#ffffff" align="center">
<a><xsl:attribute name="href"><xsl:value-of select="Template/heroModule/@url"/>%%=OmnitureParams('')=%%</xsl:attribute><img><xsl:attribute name="src"><xsl:value-of select="$imgMailPath"/><xsl:value-of select="../@type" /><xsl:value-of select="../ID/@issue" />_hero_<xsl:value-of select="Template/heroModule/@size" />_<xsl:value-of select="$version_num1" /><xsl:value-of select="Template/heroModule/@imgType" /></xsl:attribute> <xsl:attribute name="width">800</xsl:attribute> <xsl:attribute name="border">0</xsl:attribute> <xsl:attribute name="alt"><xsl:value-of select="Template/heroModule/@altText"/></xsl:attribute></img></a></td></tr></table></td>
							...
							<tr>
														...
														<tr>
															<td bgcolor="#ffffff" valign="top" background="http://www.expedia.com/eta/spaceit.gif" height="192">
																...
																<tr>
																	<td height="100%" valign="top">
																		<xsl:if test="@my:headline='yes'">
																		<span style="font-family: arial, helvetica, sans serif; font-size: 16px; color: #4b88b4; font-weight: bold;">
																		<xsl:for-each select="headline"><xsl:value-of select="."  disable-output-escaping="yes" /><br/></xsl:for-each></span></xsl:if>
																		<xsl:if test="@my:subheadline='yes'">
																		<span style="font-family: arial, helvetica, sans serif; font-size: 14px; color: #4b88b4; font-weight: bold;">
								...
								<tr>
									<td valign="top">
										...
										<tr>
											<td width="10"></td>
											<td height="28" align="left" valign="middle" style="font-family: arial, helvetica, sans serif; font-size: 14px; color: #4b88b4; font-weight: bold;"><xsl:value-of select="headline"  disable-output-escaping="yes" /></td>
											<td width="10"></td>
										</tr>
										</table>
										</xsl:if>
										...
										<tr>
													<td width="525" bgcolor="#ffffff">										
																...
																<xsl:for-each select="headline">
																	<span style="font-family: arial, helvetica, sans serif; font-size: 14px; color: #4b88b4; font-weight: bold;"><xsl:value-of select="."  disable-output-escaping="yes" /><br/></span>									
																</xsl:for-each>
																</xsl:if>
		...
		<xsl:otherwise><xsl:value-of select="$offersLink"/>%%=OmnitureParams('')=%%</xsl:otherwise>
							...
							<tr>
								<td height="1" bgcolor="#7da6d4" style="line-height: 1px; color: #7da6d4;"></td>
							</tr>
							<tr>
								<td height="5" bgcolor="#ffffff"></td>
							</tr>
			...
			<xsl:if test="Template[@my:c_col='yes']">
			<td width="5" bgcolor="#ffffff"><img src="http://www.expedia.com/eta/spaceit.gif" width="5" height="1" /></td>	
			<td width="262" valign="top" bgcolor="#ffffff">
				<table width="262" cellpadding="5" cellspacing="0" border="0">
				<tr>
					<td width="258" valign="top" bgcolor="#e5edf8">
						<table width="258" cellpadding="1" cellspacing="0" border="0">
						<tr>
						<td width="258" valign="top" bgcolor="#ffffff">
						<table width="258" cellpadding="1" cellspacing="0" border="0">
						<tr>
							<td bgcolor="#a8a9ad" width="258">
...
<td height="5" bgcolor="#89a5cc"></td>
     ...
     <option value="WAS">Washington, D.C.</option></select></td>
								...
								<xsl:for-each select="my:singleOffer">
										...
										<tr>
											<td width="258" bgcolor="#d7dce8">
												...
												<tr>
													<td width="10"></td>
													<td height="28" align="left" valign="middle" style="font-family: arial, helvetica, sans serif; font-size: 14px; color: #4b88b4; font-weight: bold;"><xsl:value-of select="my:singleHeadline"  disable-output-escaping="yes" /></td>
													<td width="10"></td>
												</tr>
												</table>
												</xsl:if>
														...
														<tr>
															<td align="left">
																<xsl:for-each select="my:singleHeadline">
																	<div style="font-family: arial, helvetica, sans serif; font-size: 14px; color: #4b88b4; font-weight: bold;">
								...
								<xsl:if test="Template/offerModule[@my:a800='yes']">
								<table width="258" cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td width="258" valign="top">
										<img src="http://media.expedia.com/media/content/expus/graphics/mail/800.gif" width="258" height="56" border="0" align="absmiddle" alt="Customer Support" /></td>
								</tr>
								</table>
								</xsl:if>
...
<tr>
		<td align="left" bgcolor="#ffffff" width="100%">
			...
			<tr>
				<td width="5"></td>
<td valign="bottom"><a href="http://www.expedia.com/daily/flights/default.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979; text-decoration: none;">Flights</a></td><td style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979;">|</td><td valign="bottom"><a href="http://www.expedia.com/daily/hotels/default.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979; text-decoration: none;">Hotels</a></td><td style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979;">|</td><td valign="bottom"><a href="http://www.expedia.com/daily/cars/default.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979; text-decoration: none;">Cars</a></td><td style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979;">|</td><td valign="bottom"><a href="http://www.expedia.com/daily/packages/default.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979; text-decoration: none;"><nobr>Vacation Packages</nobr></a></td><td style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979;">|</td><td valign="bottom"><a href="http://www.expedia.com/daily/cruise/default.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979; text-decoration: none;">Cruises</a></td><td style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979;">|</td><td valign="bottom"><a href="http://www.expedia.com/daily/activities/default.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979;  text-decoration: none;">Activities</a></td><td style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979;">|</td><td valign="bottom"><a href="http://www.expedia.com/daily/deals/default.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979; text-decoration: none;"><nobr>Deals &amp; Destinations</nobr></a></td>
<td style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979;">|</td><td valign="bottom"><a href="http://www.expedia.com/daily/business/default.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979; text-decoration: none;"><nobr>Business Travel</nobr></a></td><td style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979;">|</td><td valign="bottom"><a href="http://www.expedia.com/daily/highlights/rewards/Thank-You-Network.asp?%%=OmnitureParams('')=%%" style="font-family: arial, helvetica, sans serif; font-size: 12px; font-weight: bold; color: #797979; text-decoration: none;"><nobr>ThankYou <xsl:text disable-output-escaping="yes">&amp;#174;</xsl:text></nobr></a></td>
		</tr>
		</table></td>
</tr>
</table>
...
<table><xsl:attribute name="width"><xsl:if test="Template[@my:c_col='no'] and Template/navTabs[@my:visible='no']">550</xsl:if><xsl:if test="Template[@my:c_col='yes']">826</xsl:if></xsl:attribute><xsl:attribute name="cellpadding">0</xsl:attribute><xsl:attribute name="cellspacing">0</xsl:attribute><xsl:attribute name="bgcolor">#<xsl:value-of select="Template/@color" /></xsl:attribute>
<tr>
